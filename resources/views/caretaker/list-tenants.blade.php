            ...
            <div class="page-title-actions">
               <div class="d-inline-block dropdown">
                  <a href="{{ url('landlord/add-tenant') }}">
                     <button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-plus"></i> 
                        New Tenant
                     </button>
                  </a>

                  
                  <a href="{{ url('landlord/tenant-bulk-upload') }}"><button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">
                  Tenants Bulk Upload
                  </button></a>
               </div>
            </div>
