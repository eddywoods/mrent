         ...
         <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
               <div class="d-inline-block dropdown">
                  ...
                  <a href="{{ url('landlord/tenant-bulk-upload') }}"><button type="button" class="btn mr-2 mb-2 btn-dark text-white" data-toggle="modal" data-target=".bd-example-modal-lg">
                  Tenants Bulk Upload
                  </button></a>
               </div>
            </div>
                  ...
                  <tr>
                     ...
                     <td class="text-center">
                        <div role="group" class="btn-group-sm btn-group">
                           <a href="{{url('landlord/tenant-details', $t->userid)}}"><i class="text-success fas fa-eye"></i></a>
