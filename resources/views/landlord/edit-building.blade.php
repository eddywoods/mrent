                  ...
                  <div class="main-card mb-3 card">
                     <div class="row">
                        <div class="col-md-10 offset-md-1 shadow p-3 mb-5 bg-white rounded">
                           ...
                           <div class="card-body">
                              <form action="/landlord/building/{{ $building->id }}" method="POST" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                 <div class="row">
                                    <div class="col col-6">
                                 ...
                                 <div style="padding: 20px; margin-left: 70%">
                                    <button class="btn-shadow btn-wide btn btn-info btn-lg pull-right" type="submit">Update Building</button>
                                 </div>
