       ...
       <div class="app-page-title">
          <div class="page-title-wrapper">
             ...
             <div class="page-title-actions">
                ...
                <button type="button" id="abill" class="btn mr-2 mb-2 btn-dark text-white" data-toggle="modal" data-target="#exampleModalLong">
                    Attach Bills
                </button>
             </div>
          </div>
          ...
          <tbody>
              ...
              <td class="text-center">
                  <div role="group" class="btn-group-sm btn-group">
                      <form method="POST" action="/landlord/bill/{{$b->id}}">
                        @method('DELETE')
                        @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <button type="submit" class="btn btn-dark text-white">Attach Bill</button>
            </div>
          </form>
         </div>
    </div>
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col col-6">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-dark text-white">Create Bill</button>
                  </div>
              </form>
       </div>
    </div>
