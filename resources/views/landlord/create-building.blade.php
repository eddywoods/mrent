                  ...
                  <div class="main-card mb-3 card">
                     <div class="row">
                        <div class="col-md-12 shadow p-3 mb-5 bg-white rounded">
                           ...
                           <div class="card-body">
                              <form action="{{ url('/landlord/create-building') }}" method="POST" enctype="multipart/form-data">
                                 @csrf
                                 <div class="row">
                                    <div class="col col-6">
                                    ...
                                    <div class="col col-6">
                                       ...
                                       <div class="col col-4">
                                          <div class="position-relative form-group">
                                             <label for="exampleEmail5">Building Main Photo</label>
                                             <input class="btn btn-warning alert alert-warning" name="image" type="file">
                                          </div>
                                       </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                             ...
                                             <p class="text-warning">Configure Units</p>
                                             ...
                                             <button class="btn-shadow btn-wide btn btn-warning btn-lg pull-right text-white" type="submit">Submit Details</button>
