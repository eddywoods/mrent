         ...
         <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-3 mb-2 btn-dark text-white" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-money-bill"></i>  
                  Generate Bill
                  </button>
               </div>
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-3 mb-2  btn-dark text-white" data-toggle="modal" data-target="#paymentModal"><i class="fa fa-money"></i> 
                  Make Payment
                  </button>
               </div>
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-3 mb-2 btn-dark text-white" data-toggle="modal" data-target="#attachunitModal"><i class="fa fa-building-o"></i>  
                  Attach A Unit
                  </button>
               </div>
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-3 mb-2  btn-dark text-white" data-toggle="modal" data-target="#documentModal"><i class="fa fa-file-o"></i> 
                  Upload Document
                  </button>
               </div>
            </div>
