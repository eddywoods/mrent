         ...
         <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-2 mb-2 btn-dark" data-toggle="modal" data-target=".bd-example-modal-lg">
                  Add New Tenant
                  </button>
                  <button type="button" class="btn mr-2 mb-2 btn-dark" data-toggle="modal" data-target=".bd-caretaker-modal-lg">
                     Create Caretaker
                  </button>
                  <button type="button" id="abill" class="btn mr-2 mb-2 btn-dark" data-toggle="modal" data-target="#exampleModalLong">
                  Attach Fixed Bills
                  </button>
               </div>
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-2 mb-2 btn-dark" data-toggle="modal" data-target="#documentModal">
                  Upload Documents
                  </button>
               </div>
               
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-2 mb-2 btn-dark" data-toggle="modal" data-target="#labelModal">
                  Create Unit Label
                  </button>
               </div>
                                    ...
                                    <div class="modal-body">
                                       <div class="col-md-12">
                                          <div class="row">
                                                ...
                                                <div class="control-group" id="fields">
                                                   <div class="controls">
                                                      <div class="entry input-group col-xs-3">
                                                         <input class="btn btn-warning text-white" name="image" type="file">
                                             ...
                                             <div class="col-md-6">
                                                <button type="submit" class="btn btn-lg text-white btn-dark pull-right">Upload Photo</button>
                                             </div>
                                          </div>
                                       </div>
      ...
      <div class="modal-content">
         ...
         <form action="{{url('landlord/attach-bill')}}" method="POST">
            ...
            <div class="modal-footer">
               ...
               <button type="submit" class="btn btn-warning text-white">Attach Bill</button>
            </div>
         </form>
      </div>
   </div>
...
<div class="modal fade" id="documentModal" tabindex="-1" role="dialog" aria-labelledby="documentModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="documentModalLabel">Upload Building Documents</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>
         <form action="{{url('landlord/upload-document')}}" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
               @csrf
               <div class="col col-12">
               ...
               <div class="col col-12">
                  <div class="position-relative form-group">
                     <label for="exampleFile" class="col-sm-12 col-form-label">Upload Building Documents</label>
                     <div class="col-sm-12">
                        <input name="building_document" id="buildingFile" type="file" class="form-control-file">
                     </div>
                  </div>
               </div>
               <input type="hidden" name="building_id" value="{{$building->bid}}">
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
               <button type="submit" class="btn btn-warning text-white">Upload Document</button>
            </div>
         </form>
      </div>
   </div>
...
<div class="modal fade" id="labelModal" tabindex="-1" role="dialog" aria-labelledby="labelModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="labelModalLabel">Create Unit Label</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>
         <form action="{{url('landlord/add-label')}}" method="POST">
            <div class="modal-body">
               @csrf
               <div class="col col-12">
                     <div class="position-relative form-group">
                  ...
                  <div class="col col-12">
                        <div class="position-relative form-group">
                           <label for="" class="">Rent Amount</label>
                           <input name="unit_price" placeholder="e.g 20000" type="number" class="form-control" value="{{ old('unit_price') }}">
                        </div>
                     </div>
                     <div class="col col-12">
                        <div class="position-relative form-group">
                           <label for="" class="">Deposit Amount</label>
                           <input name="unit_deposit" placeholder="e.g 20000" type="number" class="form-control" value="{{ old('unit_deposit') }}">
                        </div>
                     </div>


               <div class="col col-12">
                  <label for="exampleFile" class="col-sm-12 col-form-label">Label Name</label>
                  <div class="col-sm-12">
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
               <button type="submit" class="btn btn-warning text-white">Save Label</button>
            </div>
         </form>
      </div>
   </div>
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <form action="{{url('landlord/add-tenant')}}" method="POST" style="padding: 40px">
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
               <button type="submit" class="btn btn-warning text-white">Create Tenant</button>
            </div>
         </form>
      </div>
   </div>
...
<!-- caretaker modal -->
<div class="modal fade bd-caretaker-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add New Caretaker</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>
         <form action="{{url('landlord/add-caretaker')}}" method="POST" style="padding: 40px">
            @csrf
            <div class="modal-body">
               <div class="row">
                  <div class="col col-6">
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
               <button type="submit" class="btn btn-warning text-white">Create Caretaker</button>
            </div>
         </form>
      </div>
   </div>
