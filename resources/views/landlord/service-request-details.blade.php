      ...
      <div class="app-page-title">
         <div class="page-title-wrapper">
            <div class="page-title-heading">
               ...
               <div>
                  {{$service_request->request_title}} service request details
               </div>
            </div>
            <div class="page-title-actions">
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-3 mb-2 btn-dark text-white" data-toggle="modal" data-target="#exampleModal">
                  Assign Request
                  </button>
               </div>
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-3 mb-2 btn-dark text-white" data-toggle="modal" data-target="#paymentModal">
                 Complete Request
                  </button>
               </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form action="{{url('landlord/assign-service-request')}}" method="POST">
            ...
            <div class="modal-footer">
               ...
               <button type="submit" class="btn btn-warning text-white">Assign Vendor</button>
            </div>
         </form>
      </div>
   </div>
...
<div class="modal fade" id="paymentModal" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form action="{{url('landlord/complete-service-request')}}" method="POST">
            @csrf
            <div class="modal-body">
               <div class="col col-12">
                  <div class="position-relative form-group">
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
               <button type="submit" class="btn btn-warning text-white">Complete Request</button>
            </div>
         </form>
      </div>
   </div>
