            ...
            <div class="row">
              <div class="col col-6">
                  <div class="position-relative form-group">
                    <label for="exampleEmail" class="">Request Title </label>
                    <input name="request_title"  placeholder="request title" type="text" class="form-control">
                  </div>
                </div>
              ...
              <div class="col col-6">
                ...
                <div class="col col-12">
                   <label for="" class="">Request Description</label>
                  <div class="position-relative form-group">
