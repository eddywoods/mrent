         ...
         <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-2 mb-2 btn-dark text-white" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-user"></i> 
                  Add New Tenant
                  </button>
                  <button type="button" id="abill" class="btn mr-2 mb-2 btn-dark text-white" data-toggle="modal" data-target="#exampleModalLong"><i class="fa fa-money-bill"></i> 
                  Attach Fixed Bills
                  </button>
               </div>
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-2 mb-2 btn-dark text-white" data-toggle="modal" data-target="#documentModal"><i class="fa fa-file-o"></i> 
                  Upload Documents
                  </button>
               </div>
               <div class="d-inline-block dropdown">
                  <button type="button" class="btn mr-2 mb-2 btn-dark text-white" data-toggle="modal" data-target="#labelModal"><i class="fa fa-file"></i> 
                  Create Unit Label
                  </button>
               </div>
                                    ...
                                    <div class="modal-body">
                                       <div class="col-md-12">
                                          <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                <button type="submit" class="btn btn-lg btn-dark text-white pull-right">Upload Photo</button>
                                             </div>
                                          </div>
                                       </div>
                              ...
                              <tr>
                                 ...
                                 <td class="text-center">
                                    <div role="group" class="btn-group-sm btn-group">
                                       <a href="{{url('agent/tenant-details', $t->tenant_id)}}"><button class="btn-shadow btn btn-success"><i class="fas fa-eye"></i></button></a>
                                 </td>
                              </tr>
                              @endforeach
                              @endif
...
<div class="modal fade" id="documentModal" tabindex="-1" role="dialog" aria-labelledby="documentModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form action="{{url('agent/upload-document')}}" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
               @csrf
               <div class="col col-12">
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
               <button type="submit" class="btn btn-dark text-white">Upload Document</button>
            </div>
         </form>
      </div>
   </div>
...
<div class="modal fade" id="labelModal" tabindex="-1" role="dialog" aria-labelledby="labelModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form action="{{url('agent/add-label')}}" method="POST">
            <div class="modal-body">
               @csrf
               <div class="col col-12">
                     <div class="position-relative form-group">
